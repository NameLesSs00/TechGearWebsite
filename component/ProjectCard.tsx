    ...
    return (
      ...
      >
        <div className="order-2 flex min-h-[430px] flex-col items-start justify-center p-8 sm:p-12 lg:order-none lg:p-14">
          ...
          <Link href={`/${locale}/work/${project.id}`} className="mt-8 inline-flex items-center justify-center gap-2 rounded-full bg-[#22D3EE] px-8 py-3 text-sm font-bold text-[#011022] transition-transform hover:scale-105">
